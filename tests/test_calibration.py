...
from fordead.validation.dieback_detection_from_dataframe import (
...
def test_obs(input_dir, output_dir):
    ...
    x = [642385.0]  # index=122
    y = [5451865.0]  # index=219
    wrong_tile = "T31UGP"
    good_tile = "T31UFQ"
...
def test_calibration(input_dir, output_dir, sentinel_source):
    ...
    if sentinel_source == "THEIA":
        sentinel_source = (
            input_dir / "sentinel_data" / "validation_tutorial" / "sentinel_data"
        )
