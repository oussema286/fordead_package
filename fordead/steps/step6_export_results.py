...
def export_results(
    ...
    if tile.parameters["Overwrite"] : 
        tile.delete_dirs("periodic_results_decline","result_files") #Deleting previous detection results if they exist
    ...
    if exporting:
        ...
        if multiple_files:
            ...
            if not(periodic_results.empty):
                periodic_results.to_file(tile.paths["periodic_results_decline"],index = None)
