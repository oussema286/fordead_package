...
"""
import click
from fordead.ImportData import TileInfo, import_forest_mask
...
@click.option("-f", "--forest_mask_source",  type=str, default=None,
                    help="Source of the forest mask, accepts 'BDFORET', 'OSO', the path to a binary raster with the extent and resolution of the computed area, or None in which case all pixels will be considered valid", show_default=True)
...
def compute_forest_mask(data_directory,
    ...
    forest_mask_source : str
        Source of the forest mask, accepts 'BDFORET', 'OSO', the path to a binary raster with the extent and resolution of the computed area, or None in which case all pixels will be considered valid
    ...
    if tile.paths["ForestMask"].exists():
        ...
        if Path(forest_mask_source).is_file():
            ...
            forest_mask = import_forest_mask(forest_mask_source)
