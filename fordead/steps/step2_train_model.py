...
def train_model(
    ...
    if tile.parameters["Overwrite"] : 
        tile.delete_dirs("coeff_model","AnomaliesDir","state_decline" ,"periodic_results_decline","result_files","timelapse","series") #Deleting previous training and detection results if they exist
