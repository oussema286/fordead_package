...
if __name__ == '__main__':
    ...
    export_shp = "D:/PROJETS/PRJ_FORDEAD/TEST_STAC/data/export02.shp"
    export_csv = "D:/PROJETS/PRJ_FORDEAD/TEST_STAC/data/export02.csv"
    ...
    print(f"durée 'obs_to_s2_grid': {duration/60} seconds")

    start_time = time.time()
    extract_reflectance(export_shp, coll, export_csv)
    duration = time.time() - start_time
    print(f"durée 'extract_reflectance: {duration/60} seconds")
