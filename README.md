...
[![version](https://img.shields.io/badge/dynamic/json.svg?label=version&url=https://gitlab.com/fordead/fordead_package/-/jobs/artifacts/master/raw/badges.json?job=make-badge&query=version&colorB=green)](https://gitlab.com/fordead/fordead_package)
