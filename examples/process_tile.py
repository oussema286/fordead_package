...
def parse_command_line():
    ...
    parser.add_argument("-c", "--lim_perc_cloud", dest = "lim_perc_cloud",type = float,default = 0.4, help = "Maximum cloudiness at the tile or zone scale, used to filter used SENTINEL dates")
