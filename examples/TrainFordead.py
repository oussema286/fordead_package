...
def parse_command_line():
    ...
    parser.add_argument("-d", "--data_directory", dest = "data_directory",type = str,default = "C:/Users/admin/Documents/Deperissement/fordead_data/tests/OutputFordead/ZoneTestLarge", help = "Dossier avec les indices de végétations et les masques")
...
def train_model(
    ...
    # tuile.paths["VegetationIndex"]["2020-06-01"]
