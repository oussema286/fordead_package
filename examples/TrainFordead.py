...
from fordead.ImportData import ImportMaskForet, import_stackedmaskedVI, TileInfo
...
def trainfordead(
    ...
    forest_mask = ImportMaskForet(tuile.paths["ForestMask"])
    
    # Import des index de végétations et des masques
    stack_vi, stack_masks = import_stackedmaskedVI(tuile,date_lim_learning="2018-06-01")
    ...
    tuile.add_path("model_coeff", tuile.data_directory / "DataModel" / "Model_coeff.tif")
    ...
    write_tif(coeff_model,stack_vi.attrs, tuile.paths["model_coeff"])
