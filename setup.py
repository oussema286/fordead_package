...
# PROGRAMMERS:
# 
# Raphael Dutrieux <raphael.dutrieux@>
# https://gitlab.com/jbferet/fordead_package
#
# COPYRIGHT:
#
# Copyright 2020 Raphael Dutrieux, INARE
#
# This file is part of the fordead_package package.
#
# fordead_package is free software: you can redistribute it and/or modify
...
setup(
    ...
    description="description fordead",
    long_description='longue description de fordead',

    # Project's main homepage.
    url='https://gitlab..com/jbferet/fordead',

    # Author details
    author='Raphael Dutrieux, Jean-Baptiste Féret',
    author_email='raphael.dutrieux@inrae.fr',
    ...
    entry_points={'console_scripts': [
            'fordead = fordead.cli.__main__:fordead',
        ],},
)
