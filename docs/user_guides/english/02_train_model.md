...
- In the **TimelessMasks** directory, the binary raster **valid_model_mask.tif** which is 1 for pixels where the model could be computed, 0 if there were not enough valid dates.
