...
> **_Fonctions utilisées:_** [rasterize_vector()][fordead.masking_vi.rasterize_vector]
...
Cette option est donnée pour les utilisateurs voulant créer leur propre masque par d'autres moyens et l'utiliser dans la chaîne de traitement. Il sera ré-écrit dans le dossier data_directory.
 ...
 > **_Fonctions utilisées :_** [import_binary_raster()][fordead.import_data.import_binary_raster], [clip_xarray()][fordead.import_data.clip_xarray]
...
- Rasterisation en un masque binaire
 > **_Fonctions utilisées :_** [rasterize_bdforet()][fordead.masking_vi.rasterize_bdforet], [rasterize_polygons_binary()][fordead.masking_vi.rasterize_polygons_binary], [bdforet_paths_in_zone()][fordead.masking_vi.bdforet_paths_in_zone]
...
### A partir de carte OSO du CESBIO
 ...
 > **_Fonctions utilisées :_** [clip_oso()][fordead.masking_vi.clip_oso]
...
### Pas d'utilisation de masque
 ...
 > **_Fonctions utilisées :_** [raster_full()][fordead.masking_vi.raster_full]
